...
path. The file imports them via the following lines.

.. literalinclude:: ../data_management/generate_data.do
    :start-after: // Read in the model controls
...
.. literalinclude:: ../data_management/generate_data.do
    :start-after: gen x2 = 1
    :end-before: forvalues N = 1 / 9 {
    
Then the measurements are generated by using the factors of first period and 
measurement equations.

.. literalinclude:: ../data_management/generate_data.do
    :start-after: gen fac`K'1  = sqrt(${var_p_`K'})*invnorm(uniform())
    :end-before: local t = 2
...
measurement values are generated as well by iterating period form 2 to 8.


.. literalinclude:: ../data_management/generate_data.do
    :start-after: sqrt(${var_`N'})*invnorm(uniform())
    :end-before: forvalues N = 1 / 6 { 
...
Finally, we merged the data via *factorid* variable. 
